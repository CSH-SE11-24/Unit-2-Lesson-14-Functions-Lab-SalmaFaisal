...
if (questions[0].question === "Paris,France") {
  console.log("You've got it right! Next question.")
} else {
  console.log("Incorrect, try again.")
}
return questions[0].correct
}
console.log ("You're on a journey to success, the company is willing to invest in you")
  ...
  let questions = [
    {
      question: prompt("Where did the fashion industry originate?"),
    ...
    {
      question: "What is victoria secret?",
      correct: "American lingerie, clothing and beauty retailer",
      option1: "Food company",
      option2: "Mechanic Shop",
      option3: "Small business",
  ...
  if (questions[1].question === "American lingerie, clothing and beauty retailer") {
    console.log("You've got it right! Next question.")
  } else {
    console.log("Incorrect, try again.")
  }
  return questions[1].correct
}
